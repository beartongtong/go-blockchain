...
#3000钱包地址
$wallet1 = "18YkgMpHA1qnPFEQm6SZU6JKBpKdMthv5E"
$wallet2 = "1AGQPhZeipC4BMWVezmsdNtoZRGdpAqQAA"
$wallet3 = "1LU7FMux1WKhVs2yviye5JL9ExySTk2z9L"
#3001钱包
$wallet4 = "1NuBmM2YNuGYQtEWxwdXHarCEZXnWNTgrJ"
$wallet5 = "1FYUbCCKQR24wH7j8cbcPxNQcMBvrvcqQ6"
$wallet6 = "1CQSz9VGxVDWSjjD5PKaLKPsXhWxS7ev82"
#3002矿工钱包地址
$wallet7 = "13sKp9235KEyPzWR3sf3PiZUduVGvQvkyx"
#3003矿工钱包地址
$wallet8 = "12NgPZE85XgaYc2h7G1EHiMZasZwBhU4dK"
...
#设置程序端口号
#Set-Item -Path "env:NODE_ID" -Value "192.168.254.129 3001"
# 测试
function test {
    build
    Write-Host "====>testsend"
...
function send {
    Write-Host "====>send"
    & $BINARY send -from $wallet4 -to $wallet5 -amount 1
}
